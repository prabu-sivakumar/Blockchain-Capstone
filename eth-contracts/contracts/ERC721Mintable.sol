...
contract Ownable {
    ...
    modifier onlyOwner() {
        require(_owner == msg.sender, "Caller must be the Contract Owner.");
        _;
    }
...
contract Pausable is Ownable {
    ...
    modifier whenNotPaused() {
        require(!_paused, "Contract Execution is currently paused.");
        _;
    }

    modifier paused() {
        require(_paused, "Contract Execution is not paused.");
        _;
    }
...
contract ERC721 is Pausable, ERC165 {
    ...
    function approve(address to, uint256 tokenId) public {
        ...
        require(owner != to, "Approver cannot be the Owner of the Token");
        // TODO require the msg sender to be the owner of the contract or isApprovedForAll() to be true
        require(
            msg.sender == owner || isApprovedForAll(owner, msg.sender),
            "Message Sender should be the owner of the Contract or Approved for all needs to be enabled."
        );
    ...
    function _transferFrom(
        ...
        require(
            ...
            "From Address should be the Owner of the Token."
        );
